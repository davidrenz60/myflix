...
small_cover_url = "http://dummyimage.com/166x236/000000/00a2ff"
...
Video.create(title: "Breaking Bad", description: breaking_bad_desc, small_cover_url: small_cover_url, large_cover_url: large_cover_url, category: drama)

Video.create(title: "Better Call Saul", description: better_call_saul_desc, small_cover_url: small_cover_url, large_cover_url: large_cover_url, category: comedy)
Video.create(title: "Better Call Saul", description: better_call_saul_desc, small_cover_url: small_cover_url, large_cover_url: large_cover_url, category: comedy)
Video.create(title: "Family Guy", description: family_guy_desc, small_cover_url: small_cover_url, large_cover_url: large_cover_url, category: comedy)
Video.create(title: "Family Guy", description: family_guy_desc, small_cover_url: small_cover_url, large_cover_url: large_cover_url, category: comedy)
Video.create(title: "Monk", description: monk_desc, small_cover_url: small_cover_url, large_cover_url: large_cover_url, category: comedy)
Video.create(title: "Futurama", description: futurama_desc, small_cover_url: small_cover_url, large_cover_url: large_cover_url, category: comedy)
Video.create(title: "South Park", description: south_park_desc, small_cover_url: small_cover_url, large_cover_url: large_cover_url, category: comedy)
